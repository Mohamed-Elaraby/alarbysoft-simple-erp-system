                            ...
                            <main>
                                <div class="row contacts">
                                    <div class="col invoice-to">
                                        ...
                                        <h2 class="to">{{ $purchasesOrder->supplier->name }}</h2>
                                        <div class="address">796 Silver Harbour, TX 79273, US</div>
                                        <div class="email"><a href="mailto:john@example.com">john@example.com</a></div>
                                    </div>
                                    <div class="col invoice-details">
                                        <h1 class="invoice-id">INVOICE {{ $purchasesOrder->invoiceNo }}</h1>
                                        <div class="date">Date of Invoice: {{ $purchasesOrder->invoiceDate }}</div>
                                    </div>
                                </div>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tbody>
                                        @foreach ($purchasesOrder->purchaseOrderProducts as $order)
                                            <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $purchasesOrder->invoice_subtotal }} E.G</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
                                        <td colspan="2">TAX 14%</td>
                                        <td>{{ $purchasesOrder->tax_percent }}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"></td>
