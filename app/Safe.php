...
{
    protected $fillable = [
        'amount_paid','final_amount', 'comment', 'processType', 'recall', 'user_id', 'client_payment_id', 'client_collecting_id', 'sale_order_id', 'supplier_payment_id', 'supplier_collecting_id', 'purchase_order_id'
    ];
